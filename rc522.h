#ifndef __RC522_REGMAP_H__
#define __RC522_REGMAP_H__

#include <errno.h>
#include <zephyr/device.h>
#include <zephyr/drivers/spi.h>

/* Firmware version string constants */
#define FM17522_VERSION_STR "FM17522 (0x88)"
#define MFRC522_VERSION_V0_0_STR "MFRC522 v0.0 (0x90)"
#define MFRC522_VERSION_V1_0_STR "MFRC522 v1.0 (0x91)"
#define MFRC522_VERSION_V2_0_STR "MFRC522 v2.0 (0x92)"
#define MFRC522_VERSION_UNKNOWN "Unknown RFID IC version"
...
enum Register {
  ...
  GsNReg = 0x27 << 1, // selects the conductance of the antenna driver pins TX1
  ...
  TPrescalerReg = 0x2B << 1, // the lower 8 bits of the TPrescaler value. The 4
...
enum PICC_Command {
  ...
  PICC_CMD_WUPA = 0x52, // Wake-UP command, Type A. Invites PICCs in state IDLE
                        // and HALT to go to READY(*) and prepare for
...
enum MIFARE_Misc {
  MF_ACK = 0xA, // The MIFARE Classic uses a 4 bit ACK/NAK. Any other value than
                // 0xA is NAK.
